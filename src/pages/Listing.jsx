  ...
  return (
    <main>
      ...
      {shareLinkCopied && (
        ...
        right-[5%] font-semibold border-2 border-gray-400
    ...
    lg:mx-auto p-4 rounded-lg  shadow-lg bg-white lg:space-x-5 ">
      <div className="w-full">
        ...
        space-x-4 w-[75%]">
          ...
          {listing.offer && (
            ...
            bg-green-800 rounded-md p-1 text-white text-center
            font-semibold shadow-md'>
              ${+listing.regularPrice -  +listing.discountedPrice} discount</p>
          )}
        </div>
        <p className='mt-3 mb-3'>
        <span className='font-semibold'>Description -
        </span>
        {listing.description}
        </p>
        <ul className='flex items-center space-x-2 sm:space-x-10
      ...
      overflow-x-hidden mt-6 lg:mt-0 md:ml-2">
